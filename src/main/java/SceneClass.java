...
public class SceneClass {
	...
	public void loadScene(String imageScenePath) {
		...
		JLabel jbutton = new JLabel("<html><h1 color=white>Jopa</h1></html>");
		player = new Sound("/home/rob/Desktop/VNGame/src/ntpp.wav");
		player.createSound();
		...
		final RainPanel rainPanel = new RainPanel(imageScenePath);
